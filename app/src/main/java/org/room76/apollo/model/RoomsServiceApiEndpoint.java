...
public final class RoomsServiceApiEndpoint {
    ...
    static {
        ...
        addRoom(new FirebaseUserMock("Alabama", "https://peopledotcom.files.wordpress.com/2017/07/jennifer-aniston-fragrance-2.jpg"), "Unit Cafe", "Сервіс замовлення їжі онлайн в Unit.Cafe, найкращому кафе інноваційного містечка Unit City.", true, "https://images.adsttc.com/media/images/594b/94d4/b22e/3898/a700/0492/large_jpg/10.jpg?1498125515");
    ...
    private static void addRoom(FirebaseUser author, String title, String description, boolean isOpen, String imageUrl) {
        ...
        users.add(new FirebaseUserMock("Alba", "http://v1.popcornnews.ru/upload/jsOT7y.jpg"));
        users.add(new FirebaseUserMock("Alba", "http://lichnosti.net/photos/4393/main.jpg"));
        users.add(new FirebaseUserMock("Hulk", "https://vokrug.tv/pic/person/4/c/3/8/4c385380340d56acd318cf77d7777924.jpeg"));
